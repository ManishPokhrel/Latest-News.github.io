...
async function fetchNews(){
	...
	url = `https://newsapi.org/v2/everything?q=${category}&from=2022-02-15&sortBy=publishedAt&apiKey=40c769e7e9c947998bdba482b0cdf450&page=${currentPage}&pagesize=${pagesize}`;
...
function controller(val){
	...
	url = `https://newsapi.org/v2/everything?q=tesla&from=2022-02-15&sortBy=publishedAt&apiKey=40c769e7e9c947998bdba482b0cdf450&page=${currentPage}&pagesize=${pagesize}`;
		remove()
		fetchNews();
}
